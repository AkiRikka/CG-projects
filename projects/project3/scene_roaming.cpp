...
void SceneRoaming::handleInput() {
    ...
    if (_input.keyboard.keyStates[GLFW_KEY_W] != GLFW_RELEASE) {
        ...
        camera->transform.position += cameraMoveSpeed * camera->transform.getFront() * 0.01f;
        // -------------------------------------------------
    }
    ...
    if (_input.keyboard.keyStates[GLFW_KEY_A] != GLFW_RELEASE) {
        ...
        // -------------------------------------------------
        // camera->transform.position = ...;
        camera->transform.position -= camera->transform.getRight() * cameraMoveSpeed * 0.01f;
        // -------------------------------------------------
    }
    ...
    if (isFirstUpdate)
    {
        _input.mouse.move.xOld = _input.mouse.move.xNow - 0.01f;
        _input.mouse.move.yOld = _input.mouse.move.yNow - 0.01f;
        isFirstUpdate = false;
    }
    ...
    if (_input.mouse.move.xNow != _input.mouse.move.xOld) {
        ...
        glm::quat rotation_x = glm::angleAxis(-mouseMovementX * cameraRotateSpeed, glm::vec3(0.0f, 1.0f, 0.0f));
        camera->transform.rotation = rotation_x * camera->transform.rotation;
        // -----------------------------------------------------------------------------
    }
    ...
    if (_input.mouse.move.yNow != _input.mouse.move.yOld) {
        ...
        glm::quat rotation_y = glm::angleAxis(-mouseMovementY * cameraRotateSpeed, camera->transform.getRight());
        camera->transform.rotation = rotation_y * camera->transform.rotation;
        // -----------------------------------------------------------------------------
    }
